<template>
    <div class="border-t w-full pt-12 pb-5">
        <footer class="w-full max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
                ...
                <div class="mt-3 grid space-y-3 text-sm">
                    ...
                    <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Careers</a> <span class="inline text-blue-600 dark:text-blue-500">— We're hiring</span></p>
                ...
                <div class="mt-3 grid space-y-3 text-sm">
                    ...
                    <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Status</a></p>
                    <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">GitHub</a> <span class="inline text-blue-600 dark:text-blue-500">— New</span></p>
                </div>
            ...
            <div class="pt-5 mt-5 border-t border-gray-200">
                ...
                <div class="flex items-center gap-x-3">
                    ...
                    <div class="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700" aria-labelledby="footer-language-dropdown">
                        <a class="flex items-center gap-x-2 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500" href="#">
