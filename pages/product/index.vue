                        ...
                        <div class="bg-white shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                            ...
                            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between w-full">
                                ...
                                <div class="relative w-full flex items-center gap-1 border rounded-xl">
                                    <!-- <button class="flex items-center w-8 justify-center" @click="clearSearchTerm">
                                        <Icon name="material-symbols:close-rounded" class="text-zinc-400 hover:text-zinc-800" />
                                    </button> -->
                                    ...
                                    <button class="flex items-center w-10 justify-center" @click="getProducts()">
                            ...
                            <UTable 
                                ...
                                :columns="[
                                    ...
                                    { key: 'product_category.title', label: 'Category' },
...
<script setup>
    ...
    function getAllProducts() {
        supabase
            .from('products')
            .select(`
                id, title, created_at, slug, images,
                product_category(
                    title
                )
            `)
